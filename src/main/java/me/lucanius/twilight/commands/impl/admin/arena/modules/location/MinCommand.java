 ...
 * @since May 24, 2022
 */
public class MinCommand extends AbstractCommand {

    @Command(name = "arena.min", permission = "twilight.admin")
    public void onCommand(CommandArgs cmd) {
        ...
        arena.setMin(new SerializableLocation(player.getLocation()));
        player.sendMessage(CC.SECOND + "Successfully set location Min for " + CC.MAIN + arena.getName() + CC.SECOND + ".");
    }
}
