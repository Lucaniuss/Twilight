...
public class DeleteCommand extends AbstractCommand {
    ...
    @Command(name = "loadout.delete", permission = "twilight.admin")
    public void onCommand(CommandArgs cmd) {
        ...
        plugin.getLoadouts().destroy(loadout);
        player.sendMessage(CC.SECOND + "Successfully deleted loadout " + CC.MAIN + loadout.getName() + CC.SECOND + ".");
    }
}
