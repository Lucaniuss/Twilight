 ...
 * @since May 25, 2022
 */
public class SetEditCommand extends AbstractCommand {

    @Command(name = "loadout.setedit", permission = "twilight.admin")
    public void onCommand(CommandArgs cmd) {
        ...
        loadout.setEdit(contents);
        player.sendMessage(CC.SECOND + "Successfully set edit for loadout " + CC.MAIN + loadout.getName() + CC.SECOND + ".");
    }
}
